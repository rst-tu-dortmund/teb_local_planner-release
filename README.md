...
## teb_local_planner (melodic) - 0.8.4-1

The packages in the `teb_local_planner` repository were released into the `melodic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro melodic` on `Mon, 02 Dec 2019 08:36:55 -0000`
...
## teb_local_planner (melodic) - 0.8.3-1

The packages in the `teb_local_planner` repository were released into the `melodic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro melodic` on `Fri, 25 Oct 2019 14:50:05 -0000`
...
## teb_local_planner (kinetic) - 0.6.14-1

The packages in the `teb_local_planner` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro kinetic` on `Fri, 25 Oct 2019 14:39:18 -0000`
...
## teb_local_planner (melodic) - 0.8.2-1

The packages in the `teb_local_planner` repository were released into the `melodic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro melodic` on `Tue, 02 Jul 2019 08:16:32 -0000`
...
## teb_local_planner (kinetic) - 0.6.13-1

The packages in the `teb_local_planner` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro kinetic` on `Mon, 01 Jul 2019 09:14:33 -0000`
...
## teb_local_planner (kinetic) - 0.6.12-1

The packages in the `teb_local_planner` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release teb_local_planner --rosdistro kinetic` on `Fri, 21 Jun 2019 11:38:32 -0000`
...
## teb_local_planner (kinetic) - 0.6.11-0

The packages in the `teb_local_planner` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release teb_local_planner --track kinetic --rosdistro kinetic` on `Tue, 14 Aug 2018 12:30:05 -0000`
...
## teb_local_planner (indigo) - 0.4.5-0

The packages in the `teb_local_planner` repository were released into the `indigo` distro by running `/usr/bin/bloom-release teb_local_planner --track indigo --rosdistro indigo` on `Tue, 14 Aug 2018 12:27:45 -0000`
...
## teb_local_planner (melodic) - 0.8.0-0

The packages in the `teb_local_planner` repository were released into the `melodic` distro by running `/usr/bin/bloom-release teb_local_planner --track melodic --rosdistro melodic --new-track` on `Mon, 06 Aug 2018 16:38:32 -0000`
...
## teb_local_planner (lunar) - 0.7.3-0

The packages in the `teb_local_planner` repository were released into the `lunar` distro by running `/usr/bin/bloom-release teb_local_planner --track lunar --rosdistro lunar` on `Thu, 05 Jul 2018 13:13:01 -0000`
...
## teb_local_planner (kinetic) - 0.6.10-0
